...
class MainActivity : Activity() {
    ...
    private fun confirmReset(){VeyraGlassDialog.showConfirm(this,"Reset Veyra?","All habits, progress, goals, mood, journal entries and achievements will be removed from this device.","RESET"){store.reset();HabitReminderStore(this).all().forEach{HabitReminderScheduler.cancel(this,it.habitId)};showHome()}}
